...
fig1 = px.histogram(filtered_df, x="Cholesterol_Level", nbins=20, title="Cholesterol Level Histogram")
st.plotly_chart(fig1)
st.subheader("Average Cholesterol by Diabetes Status")
avg_cholesterol = filtered_df.groupby("Diabetes")["Cholesterol_Level"].mean().reset_index()
